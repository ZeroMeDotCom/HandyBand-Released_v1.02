        ...
        VStack {
            HStack {
                ...
                .simultaneousGesture(TapGesture(count: 2).onEnded {
                    fileManage.stopSingleTrack(fileURL: fileManage.savedFileNames.fileNames["track6"]!["fileWay"]!, samplePlayer: fileManage.samplePlayer6, engine: fileManage.engine6)
                    self.isOn = false
                })
                ...
                VStack {
                    Slider(value: $volumeValue, in: 0...100, onEditingChanged: {_ in
                        fileManage.changeVolume(value: $volumeValue.wrappedValue, samplePlayer: fileManage.samplePlayer6)
                    })
