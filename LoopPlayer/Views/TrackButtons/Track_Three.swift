        ...
        VStack {
            ...
            if selection_effect == 0 {
                ...
                VStack {
                    ...
                    // Convolution - open/close Both left and right flover
                    HStack {
                        // Button - Left close/open
                        Button(action: {
                            self.convIsOpeningLeft = !self.convIsOpeningLeft
                            if self.convIsOpeningLeft {
                                fileManage.switchOnConvolutionLeftHalf(convolutionSalt_one: fileManage.convolutionSalt_one3, convolutionSalt_two: fileManage.convolutionSalt_two3)
                                self.convIsOpeningRight = false
                                self.convIsOpeningBoth = false
                            } else {
                                fileManage.switchffConvolutionLeftHalf(convolutionSalt_one: fileManage.convolutionSalt_one3, convolutionSalt_two: fileManage.convolutionSalt_two3)
                            }
                        ...
                        Button(action: {
                            ...
                            if self.convIsOpeningBoth {
                                fileManage.switchOnConvolutionBoth(convolutionSalt_one: fileManage.convolutionSalt_one3, convolutionSalt_two: fileManage.convolutionSalt_two3)
                                self.convIsOpeningRight = false
                                self.convIsOpeningLeft = false
                            } else {
                                fileManage.switchffConvolutionBoth(convolutionSalt_one: fileManage.convolutionSalt_one3, convolutionSalt_two: fileManage.convolutionSalt_two3)
                            }
                        ...
                        Button(action: {
                            ...
                            if self.convIsOpeningBoth {
                                fileManage.switchOnConvolutionRightHalf(convolutionSalt_one: fileManage.convolutionSalt_one3, convolutionSalt_two: fileManage.convolutionSalt_two3)
                                self.convIsOpeningBoth = false
                                self.convIsOpeningLeft = false
                            } else {
                                fileManage.switchffConvolutionRightHalf(convolutionSalt_one: fileManage.convolutionSalt_one3, convolutionSalt_two: fileManage.convolutionSalt_two3)
                            }
