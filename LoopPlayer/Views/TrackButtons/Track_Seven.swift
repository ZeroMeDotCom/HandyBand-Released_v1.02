        ...
        VStack {
            HStack {
                ...
                .simultaneousGesture(TapGesture(count: 2).onEnded {
                    fileManage.stopSingleTrack(fileURL: fileManage.savedFileNames.fileNames["track7"]!["fileWay"]!, samplePlayer: fileManage.samplePlayer7, engine: fileManage.engine7)
                    self.isOn = false
                })
                ...
                Button(action: {
                    ...
                    fileManage.addingToPlayNextTime(trackID: "track7") ?
                    ...
                    HStack {
                        ...
                        Button(action: {
                            ...
                            if self.convIsOpeningLeft {
                                fileManage.switchOnConvolutionLeftHalf(convolutionSalt_one: fileManage.convolutionSalt_one7, convolutionSalt_two: fileManage.convolutionSalt_two7)
                                self.convIsOpeningRight = false
                                self.convIsOpeningBoth = false
                            } else {
                                fileManage.switchffConvolutionLeftHalf(convolutionSalt_one: fileManage.convolutionSalt_one7, convolutionSalt_two: fileManage.convolutionSalt_two7)
                            }
                        ...
                        Button(action: {
                            ...
                            if self.convIsOpeningBoth {
                                fileManage.switchOnConvolutionBoth(convolutionSalt_one: fileManage.convolutionSalt_one7, convolutionSalt_two: fileManage.convolutionSalt_two7)
                                self.convIsOpeningRight = false
                                self.convIsOpeningLeft = false
                            } else {
                                fileManage.switchffConvolutionBoth(convolutionSalt_one: fileManage.convolutionSalt_one7, convolutionSalt_two: fileManage.convolutionSalt_two7)
                            }
                        ...
                        Button(action: {
                            ...
                            if self.convIsOpeningBoth {
                                fileManage.switchOnConvolutionRightHalf(convolutionSalt_one: fileManage.convolutionSalt_one7, convolutionSalt_two: fileManage.convolutionSalt_two7)
                                self.convIsOpeningBoth = false
                                self.convIsOpeningLeft = false
                            } else {
                                fileManage.switchffConvolutionRightHalf(convolutionSalt_one: fileManage.convolutionSalt_one7, convolutionSalt_two: fileManage.convolutionSalt_two7)
                            }
