                    ...
                    HStack {
                        ...
                        Button(action: {
                            ...
                            if self.convIsOpeningLeft {
                                fileManage.switchOnConvolutionLeftHalf(convolutionSalt_one: fileManage.convolutionSalt_one11, convolutionSalt_two: fileManage.convolutionSalt_two11)
                                self.convIsOpeningRight = false
                                self.convIsOpeningBoth = false
                            } else {
                                fileManage.switchffConvolutionLeftHalf(convolutionSalt_one: fileManage.convolutionSalt_one11, convolutionSalt_two: fileManage.convolutionSalt_two11)
                            }
                        ...
                        Button(action: {
                            ...
                            if self.convIsOpeningBoth {
                                fileManage.switchOnConvolutionBoth(convolutionSalt_one: fileManage.convolutionSalt_one11, convolutionSalt_two: fileManage.convolutionSalt_two11)
                                self.convIsOpeningRight = false
                                self.convIsOpeningLeft = false
                            } else {
                                fileManage.switchffConvolutionBoth(convolutionSalt_one: fileManage.convolutionSalt_one11, convolutionSalt_two: fileManage.convolutionSalt_two11)
                            }
                        ...
                        Button(action: {
                            ...
                            if self.convIsOpeningBoth {
                                fileManage.switchOnConvolutionRightHalf(convolutionSalt_one: fileManage.convolutionSalt_one11, convolutionSalt_two: fileManage.convolutionSalt_two11)
                                self.convIsOpeningBoth = false
                                self.convIsOpeningLeft = false
                            } else {
                                fileManage.switchffConvolutionRightHalf(convolutionSalt_one: fileManage.convolutionSalt_one11, convolutionSalt_two: fileManage.convolutionSalt_two11)
                            }
