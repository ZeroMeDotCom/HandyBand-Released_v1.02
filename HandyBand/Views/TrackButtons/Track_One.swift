        ...
        VStack {
            HStack {
                ...
                .simultaneousGesture(TapGesture(count: 2).onEnded {
                    fileManage.stopSingleTrack(fileURL: fileManage.savedFileNames.fileNames["track1"]!["fileWay"]!, samplePlayer: fileManage.samplePlayer1, engine: fileManage.engine1)
                    self.isOn = false
                })
                ...
                VStack {
                    ...
                    Button(action: {
                        ...
                        fileManage.addingToPlayNextTime(trackID: "track1") ?
                ...
                VStack {
                    Slider(value: $volumeValue, in: 0...100, onEditingChanged: {_ in
                        fileManage.changeVolume(value: $volumeValue.wrappedValue, samplePlayer: fileManage.samplePlayer1)
                    })
                    ...
                    HStack {
                        ...
                        Button(action: {
                            ...
                            if self.convIsOpeningLeft {
                                fileManage.switchOnConvolutionLeftHalf(convolutionSalt_one: fileManage.convolutionSalt_one1, convolutionSalt_two: fileManage.convolutionSalt_two1)
                                self.convIsOpeningRight = false
                                self.convIsOpeningBoth = false
                            } else {
                                fileManage.switchffConvolutionLeftHalf(convolutionSalt_one: fileManage.convolutionSalt_one1, convolutionSalt_two: fileManage.convolutionSalt_two1)
                            }
                        ...
                        Button(action: {
                            ...
                            if self.convIsOpeningBoth {
                                fileManage.switchOnConvolutionBoth(convolutionSalt_one: fileManage.convolutionSalt_one1, convolutionSalt_two: fileManage.convolutionSalt_two1)
                                self.convIsOpeningRight = false
                                self.convIsOpeningLeft = false
                            } else {
                                fileManage.switchffConvolutionBoth(convolutionSalt_one: fileManage.convolutionSalt_one1, convolutionSalt_two: fileManage.convolutionSalt_two1)
                            }
                        ...
                        Button(action: {
                            ...
                            if self.convIsOpeningBoth {
                                fileManage.switchOnConvolutionRightHalf(convolutionSalt_one: fileManage.convolutionSalt_one1, convolutionSalt_two: fileManage.convolutionSalt_two1)
                                self.convIsOpeningBoth = false
                                self.convIsOpeningLeft = false
                            } else {
                                fileManage.switchffConvolutionRightHalf(convolutionSalt_one: fileManage.convolutionSalt_one1, convolutionSalt_two: fileManage.convolutionSalt_two1)
                            }
