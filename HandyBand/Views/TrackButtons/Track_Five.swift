...
//  Who is this file? -> Track 5

import SwiftUI
import AudioKit

struct Track_Five: View {
        ...
        VStack {
            HStack {
                ...
                .gesture(TapGesture(count: 1).onEnded {
                    fileManage.playNewButton(engine: fileManage.engine5, samplePlayer: fileManage.samplePlayer5, fileURL: fileManage.savedFileNames.fileNames["track5"]!["fileWay"]!)
                    self.isOn = true
                })
                .simultaneousGesture(TapGesture(count: 2).onEnded {
                    fileManage.stopSingleTrack(fileURL: fileManage.savedFileNames.fileNames["track5"]!["fileWay"]!, samplePlayer: fileManage.samplePlayer5, engine: fileManage.engine5)
                    self.isOn = false
                })
                ...
                VStack {
                    //Send to Bus
                    Button(action: {
                        fileManage.addingToPlayNextTime(trackID: "track5") ? fileManage.setToEdit(trackID: "track5") : fileManage.setReady(trackID: "track5")
                        print(fileManage.whichToPlay)
                        
                    }, label: {
                        fileManage.addingToPlayNextTime(trackID: "track5") ?
                ...
                VStack {
                    Slider(value: $volumeValue, in: 0...100, onEditingChanged: {_ in
                        fileManage.changeVolume(value: $volumeValue.wrappedValue, samplePlayer: fileManage.samplePlayer5)
                    })
            ...
            if selection_effect == 0 {
                VStack {
                    ...
                    HStack {
                        ...
                        Slider(value: $delay_time, in: 0...10, onEditingChanged: {_ in
                            fileManage.changeDelay_time(delay_time: $delay_time.wrappedValue, delay: fileManage.delay5)
                        })
                    ...
                    HStack {
                        ...
                        Slider(value: $delay_feedback, in: 0...100, onEditingChanged: {_ in
                            fileManage.changeDelay_feedback(delay_feedback: $delay_feedback.wrappedValue, delay: fileManage.delay5)
                        })
                    }
                    HStack {
                        ...
                        Slider(value: $delay_balance, in: 0...100, onEditingChanged: {_ in
                            fileManage.changeDelay_balance(delay_balance: $delay_balance.wrappedValue, dryWetMixer: fileManage.dryWetMixer5)
                        })
                    }
                ...
                VStack {
                    ...
                    HStack
                    {
                        ...
                        .onChange(of: selection, perform: {
                            newValue in
                            fileManage.changeDelay_balance(delay_balance: 0, dryWetMixer: fileManage.dryWetMixer5)
                            fileManage.change_reverb(place: places[newValue], reverb: fileManage.reverb5)
                        })
                    }
                ...
                VStack {
                    ...
                    Slider(value: $saltMixerBalance, in: 0...1, onEditingChanged: {_ in
                        fileManage.changeConvolution_balance(convolution_balance: $saltMixerBalance.wrappedValue, saltMixer: fileManage.saltMixer5)
                    ...
                    HStack {
                        ...
                        Button(action: {
                            ...
                            if self.convIsOpeningLeft {
                                fileManage.switchOnConvolutionLeftHalf(convolutionSalt_one: fileManage.convolutionSalt_one5, convolutionSalt_two: fileManage.convolutionSalt_two5)
                                self.convIsOpeningRight = false
                                self.convIsOpeningBoth = false
                            } else {
                                fileManage.switchffConvolutionLeftHalf(convolutionSalt_one: fileManage.convolutionSalt_one5, convolutionSalt_two: fileManage.convolutionSalt_two5)
                            }
                        ...
                        Button(action: {
                            ...
                            if self.convIsOpeningBoth {
                                fileManage.switchOnConvolutionBoth(convolutionSalt_one: fileManage.convolutionSalt_one5, convolutionSalt_two: fileManage.convolutionSalt_two5)
                                self.convIsOpeningRight = false
                                self.convIsOpeningLeft = false
                            } else {
                                fileManage.switchffConvolutionBoth(convolutionSalt_one: fileManage.convolutionSalt_one5, convolutionSalt_two: fileManage.convolutionSalt_two5)
                            }
                        ...
                        Button(action: {
                            ...
                            if self.convIsOpeningBoth {
                                fileManage.switchOnConvolutionRightHalf(convolutionSalt_one: fileManage.convolutionSalt_one5, convolutionSalt_two: fileManage.convolutionSalt_two5)
                                self.convIsOpeningBoth = false
                                self.convIsOpeningLeft = false
                            } else {
                                fileManage.switchffConvolutionRightHalf(convolutionSalt_one: fileManage.convolutionSalt_one5, convolutionSalt_two: fileManage.convolutionSalt_two5)
                            }
...
struct Track_Five_Previews: PreviewProvider {
