//
//  Track_Fifteen_PlugIn_Three.swift
//  HandyBand
//
...
struct Track_Fifteen_PlugIn_Three: View {
        ...
        VStack {
            HStack {
                ...
                .gesture(TapGesture(count: 1).onEnded {
                    fileManage.playNewButton(engine: fileManage.engine15, samplePlayer: fileManage.samplePlayer15, fileURL: fileManage.savedFileNames.fileNames["track15"]!["fileWay"]!)
                    self.isOn = true
                })
                .simultaneousGesture(TapGesture(count: 2).onEnded {
                    fileManage.stopSingleTrack(fileURL: fileManage.savedFileNames.fileNames["track15"]!["fileWay"]!, samplePlayer: fileManage.samplePlayer15, engine: fileManage.engine15)
                    self.isOn = false
                })
                ...
                VStack {
                    //Send to Bus
                    Button(action: {
                        fileManage.addingToPlayNextTime(trackID: "track15") ? fileManage.setToEdit(trackID: "track15") : fileManage.setReady(trackID: "track15")
                        print(fileManage.whichToPlay)
                        
                    }, label: {
                        fileManage.addingToPlayNextTime(trackID: "track15") ?
                ...
                VStack {
                    Slider(value: $volumeValue, in: 0...100, onEditingChanged: {_ in
                        fileManage.changeVolume(value: $volumeValue.wrappedValue, samplePlayer: fileManage.samplePlayer15)
                    })
            ...
            if selection_effect == 0 {
                VStack {
                    ...
                    HStack {
                        ...
                        Slider(value: $delay_time, in: 0...10, onEditingChanged: {_ in
                            fileManage.changeDelay_time(delay_time: $delay_time.wrappedValue, delay: fileManage.delay15)
                        })
                    ...
                    HStack {
                        ...
                        Slider(value: $delay_feedback, in: 0...100, onEditingChanged: {_ in
                            fileManage.changeDelay_feedback(delay_feedback: $delay_feedback.wrappedValue, delay: fileManage.delay15)
                        })
                    }
                    HStack {
                        ...
                        Slider(value: $delay_balance, in: 0...100, onEditingChanged: {_ in
                            fileManage.changeDelay_balance(delay_balance: $delay_balance.wrappedValue, dryWetMixer: fileManage.dryWetMixer15)
                        })
                    }
                ...
                VStack {
                    ...
                    HStack
                    {
                        ...
                        .onChange(of: selection, perform: {
                            newValue in
                            fileManage.changeDelay_balance(delay_balance: 0, dryWetMixer: fileManage.dryWetMixer15)
                            fileManage.change_reverb(place: places[newValue], reverb: fileManage.reverb15)
                        })
                    }
                ...
                VStack {
                    ...
                    Slider(value: $saltMixerBalance, in: 0...1, onEditingChanged: {_ in
                        fileManage.changeConvolution_balance(convolution_balance: $saltMixerBalance.wrappedValue, saltMixer: fileManage.saltMixer15)
...
struct Track_Fifteen_PlugIn_Three_Previews: PreviewProvider {
    static var previews: some View {
        Track_Fifteen_PlugIn_Three()
    }
}
